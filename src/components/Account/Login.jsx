    ...
    checkCredentials()
      .then((res) => {
        if (res && res.result) {
          ...
          if (res.result.role === "teacher") {
            localStorage.setItem("currentTeacherId", res.result._id);
          }
          if (res.result.role === "admin") {
            localStorage.setItem("currentAdminId", res.result._id);
          }
          if (res.result.role === "student") {
            localStorage.setItem("currentStudentId", res.result._id);
          }
