...
const irelandUserSchema = new mongoose.Schema(
  {
  ...
  { collection: "IrelandUsers" }
);

const IrelandUser = mongoose.model("IrelandUser", irelandUserSchema);
module.exports = IrelandUser;
